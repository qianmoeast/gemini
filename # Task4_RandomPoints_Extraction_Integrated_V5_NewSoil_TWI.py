# -*- coding: utf-8 -*-
# Task4_RandomPoints_Extraction_SplitOutput_TimeTrack.py
...
def main():
    ...
    for year in TARGET_YEARS:
        ...
        for var in ["pet", "pre", "tmp", "tmx", "tmn"]:
            ...
            else: print(f"  [警告] 缺失气候数据 {var} {year}")
    ...
    for year in TARGET_YEARS:
        ...
        if "LULC" in df_year.columns:
            ...
            print(f"  [2] wet_{year}.csv   已保存至: {w_out}")
